...
class PipelineConfigurerTest implements VertxTest {
    ...
    void testSimplePipeline() {
        setPipeline("simple");
        assertThat(sink.getLeft()).isEqualTo("simple-console-sink");
        assertThat(sink.getMiddle()).isEqualTo("fr.myprysm.pipeline.sink.ConsoleSink");
        assertThat(pump.getLeft()).isEqualTo("simple-timer-pump");
    ...
    void testBasicPipeline() {
        setPipeline("basic");
        assertThat(sink.getLeft()).isEqualTo("basic-console-sink");
        assertThat(sink.getMiddle()).isEqualTo("fr.myprysm.pipeline.sink.ConsoleSink");
        assertThat(pump.getLeft()).isEqualTo("basic-timer-pump");
        assertThat(pump.getMiddle()).isEqualTo("fr.myprysm.pipeline.pump.TimerPump");
        ...
        assertThat(processor.getLeft()).isEqualTo("basic-no-op-processor-1-1");
    ...
    void testPipelineNames() {
        setPipeline("named");
        assertThat(sink.getLeft()).isEqualTo("named-foo-bar-sink");
        assertThat(sink.getMiddle()).isEqualTo("fr.myprysm.pipeline.sink.ConsoleSink");
        assertThat(pump.getLeft()).isEqualTo("named-custom-name-pump");
        assertThat(pump.getMiddle()).isEqualTo("fr.myprysm.pipeline.pump.TimerPump");
        assertThat(processors.size()).isEqualTo(1);
    ...
    void testMultiInstanceProcessor() {
        ...
        assertThat(sink.getLeft()).isEqualTo("multi-instance-processor-console-sink");
        assertThat(sink.getMiddle()).isEqualTo("fr.myprysm.pipeline.sink.ConsoleSink");
        assertThat(pump.getLeft()).isEqualTo("multi-instance-processor-timer-pump");
        assertThat(pump.getMiddle()).isEqualTo("fr.myprysm.pipeline.pump.TimerPump");
        assertThat(processors.size()).isEqualTo(1);
        ...
        for (int i = 0, max = processorSet.size(); i < max; i++) {
            ...
            assertThat(processor.getLeft()).isEqualTo("multi-instance-processor-no-op-processor-1-" + (i + 1));
            assertThat(processor.getMiddle()).isEqualTo("fr.myprysm.pipeline.processor.NoOpProcessor");
        }
    }
    ...
    void testMultiInstanceMultiProcessor() {
        ...
        assertThat(sink.getLeft()).isEqualTo("multi-instance-multi-processor-file-sink");
        assertThat(sink.getMiddle()).isEqualTo("fr.myprysm.pipeline.sink.FileSink");
        assertThat(pump.getLeft()).isEqualTo("multi-instance-multi-processor-timer-pump");
        assertThat(pump.getMiddle()).isEqualTo("fr.myprysm.pipeline.pump.TimerPump");
        ...
        for (int i = 0, max = processorSet.size(); i < max; i++) {
            assertProcessor(processorSet.get(i),
                    to,
                    "fr.myprysm.pipeline.processor.NoOpProcessor",
                    "multi-instance-multi-processor-no-op-processor",
                    1,
                    i + 1);
        }
        ...
        for (int i = 0, max = processorSet.size(); i < max; i++) {
            assertProcessor(processorSet.get(i),
                    ...
                    "multi-instance-multi-processor-log-processor",
                    2,
                    i + 1);
        }
