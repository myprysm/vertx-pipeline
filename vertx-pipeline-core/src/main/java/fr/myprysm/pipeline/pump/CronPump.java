...
public class CronPump extends BaseJsonPump<CronPumpOptions> implements FlowableOnSubscribe<JsonObject> {
    ...
    /**
     * The emitter to send items generated by the job.
     */
    ...
    /**
     * The counter for emitted events.
     */
    ...
    @Override
    public void subscribe(FlowableEmitter<JsonObject> sourceEmitter) throws Exception {
        this.emitter = sourceEmitter;
        JobDataMap jobData = job.getJobDataMap();
        jobData.put("emitter", sourceEmitter);
